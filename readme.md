...
[**Base de donnée**](https://dbdiagram.io/d/authentication-674f2080e9daa85aca85b6ec***REMOVED***
...
- Déconnexion
- Refresh token
- Mot de passe oublié (envoi d'email***REMOVED***
- Réinitialisation du mot de passe
- Changement de mot de passe (utilisateur connecté***REMOVED***
...
- Connexion via Google ou GitHub (un seul provider au choix***REMOVED***

### Authentification à Deux Facteurs (2FA***REMOVED***
...
- Protection contre le brute-force (rate limiting***REMOVED***
- Historique des connexions (date, IP, appareil***REMOVED***
...
- `emailVerifiedAt` : date de vérification de l'email (null = non vérifié***REMOVED***
- `twoFactorEnabledAt` : date d'activation du 2FA (null = désactivé***REMOVED***
- `disabledAt` : date de désactivation du compte (null = actif***REMOVED***
- `password` : peut être null si l'utilisateur s'inscrit via OAuth

### OAuthAccount

Comptes OAuth liés (Google ou GitHub***REMOVED***.
...
- `revokedAt` : date de révocation (null = token actif***REMOVED***
...
**NB:** Chaque membre du groupe doit contribuer (les commits seront vérifiés***REMOVED***